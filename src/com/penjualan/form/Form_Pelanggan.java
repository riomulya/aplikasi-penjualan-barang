...
public class Form_Pelanggan extends javax.swing.JPanel {
    ...
    public Form_Pelanggan() {
        ...
        String queryBarang = "SELECT id_pelanggan, nama, alamat, kontak FROM pelanggan";
        Query.getDataPelanggan(modelBarang, queryBarang);
...
//        table1.getColumnModel().getColumn(3).setCellRenderer(renderer);
    ...
    private void initComponents() {
        ...
        table1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Pelanggan", "Nama Pelanggan", "Alamat", "Kontak"
            }
        ));
