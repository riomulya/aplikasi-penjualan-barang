...
import com.penjualan.event.EventMenuCallBack;
import com.penjualan.event.EventMenuSelected;
import com.penjualan.model.Model_Menu;
...
public class Menu extends javax.swing.JPanel {
    ...
    private void initData() {
        listMenu.addItem(new Model_Menu("2", "Data Barang", Model_Menu.MenuType.MENU));
        listMenu.addItem(new Model_Menu("2", "Input Data Barang", Model_Menu.MenuType.MENU));

        listMenu.addItem(new Model_Menu("8", "Data Pelanggan", Model_Menu.MenuType.MENU));
        listMenu.addItem(new Model_Menu("8", "Input Data Pelanggan", Model_Menu.MenuType.MENU));

        listMenu.addItem(new Model_Menu("1", "Data Supplier", Model_Menu.MenuType.MENU));
        listMenu.addItem(new Model_Menu("1", "Input Data Supplier", Model_Menu.MenuType.MENU));

        listMenu.addItem(new Model_Menu("3", "Data Inventaris Barang", Model_Menu.MenuType.MENU));
        listMenu.addItem(new Model_Menu("3", "Input Data Inventaris Barang", Model_Menu.MenuType.MENU));

        listMenu.addItem(new Model_Menu("5", "Data Transaksi Penjualan", Model_Menu.MenuType.MENU));
        listMenu.addItem(new Model_Menu("5", "Input Data Transaksi Penjualan", Model_Menu.MenuType.MENU));
...
//        listMenu.addItem(new Model_Menu("5", "Date Table", Model_Menu.MenuType.MENU));
        listMenu.addItem(new Model_Menu("6", "About Me", Model_Menu.MenuType.MENU));
//        listMenu.addItem(new Model_Menu("7", "Sample Page", Model_Menu.MenuType.MENU));
        listMenu.addItem(new Model_Menu("9", "Logout", Model_Menu.MenuType.MENU));
//        listMenu.addItem(new Model_Menu("10", "Logout", Model_Menu.MenuType.MENU));
    ...
    private void initComponents() {
        ...
        listMenu = new com.penjualan.swing.ListMenu<>();

        panelMoving.setOpaque(false);

        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/penjualan/icon/RMS-logos_transparent_1.png"))); // NOI18N
        ...
        panelMovingLayout.setVerticalGroup(
            ...
            .addGroup(panelMovingLayout.createSequentialGroup()
                ...
                .addGap(15, 15, 15)
                .addComponent(listMenu, javax.swing.GroupLayout.PREFERRED_SIZE, 490, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private com.penjualan.swing.ListMenu<String> listMenu;
